 ...
 genotypeFreq(2, :) = initialGenotypeFreq;
 genotypeFreq(3, :) = initialGenotypeFreq;
 genotypeFreq(4, :) = initialGenotypeFreq;
 genotypeFreq(5, :) = initialGenotypeFreq;
 genotypeFreq(6, :) = initialGenotypeFreq;
 genotypeFreq(7, :) = initialGenotypeFreq;
 genotypeFreq(8, :) = initialGenotypeFreq;
 genotypeFreq(9, :) = initialGenotypeFreq;
 genotypeFreq(10, :) = initialGenotypeFreq;
 % 迭代模拟每个世代的基因型频率变化
 for gen = 2:numGenerations
     % 随机进行交配和基因重组
     offspring = reshape(randsample(1:3, populationSize, true, genotypeFreq(gen-1, :)), [], 2);
